        ...
        <div class="col-md-3 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-0 mt-2 text-warning">2.00% <span class="text-body ml-1"><small>(30 days)</small></span>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-3 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-0 mt-2 text-danger">0.22% <span class="text-body ml-1"><small>(30 days)</small></span>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-3 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-0 mt-2 text-success">10.00%<span class="text-body ml-1"><small>(30 days)</small></span>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-3 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-0 mt-2 text-success">22.00%<span class="text-body ml-1"><small>(30 days)</small></span>
                    </p>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-md-4 item">
                                        <div class="d-flex flex-column flex-xl-row mt-4 mt-md-0">
                                            ...
                                            <div class="content text-white">
                                                ...
                                                <p class="text-white font-weight-light pr-lg-2 pr-xl-5">The total number
                                                    of sessions within the date range. It is the period time a user is
