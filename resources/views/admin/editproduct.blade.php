            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if(\Illuminate\Support\Facades\Session::has('alert'))
                        ...
                        {{\Illuminate\Support\Facades\Session::put(null)}}
                    @endif
                    {!!Form::open(['action' => 'ProductController@editProduct', 'class' => 'cmxform', 'method' => 'PATCH' , 'id' => 'commentForm', 'enctype' => 'multipart/form-data'])!!}
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            {{Form::select('product_category',$categories,$product->product_category, ['placeholder' => 'Select Category', 'class' => 'form-control'])}}
                        </div>
                        <div class="form-group">
                            {{Form::label('product_brand', 'Product Brand')}}
                            {{Form::select('product_brand',$brands,$product->product_brand, ['placeholder' => 'Select Brand', 'class' => 'form-control'])}}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            {{Form::checkbox('product_status','active',$bool, ['class' => 'form-control'])}}
                        </div>
